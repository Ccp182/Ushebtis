    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <!--<li>
                    <a href="/OnurisPlatform/public/" class="waves-effect">
                ...
                <li>
                    <a href="{{ config('global.URL_BASE') }}infomessages" class=" waves-effect">
                        <i class="mdi mdi-message-reply-text"></i>
                        <span>Mensajes Informativos</span>
                    </a>
                </li>

                {{-- <li class="menu-title">Alertas</li>
                <li>
                    <a href="{{ config('global.URL_BASE') }}HMMAlerts" class=" waves-effect">
                        <i class="mdi mdi-file-chart"></i>
                        <span>Reporte Alertas</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ config('global.URL_BASE') }}Usuarios" class=" waves-effect">
                        <i class="mdi mdi-contacts"></i>
                        <span>Información</span>
                    </a>
                </li>
                <li>
                    <a href="{{ config('global.URL_BASE') }}HMMLogs" class=" waves-effect">
